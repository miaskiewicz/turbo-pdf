...
use turbo_html2pdf_core::layout::fragment::{
    BreakMeta, Fragment, FragmentContent, NodeId, PositionedGlyph,
};
use turbo_html2pdf_core::layout::value::{BorderEdges, BorderSide, Edges, Rgba};
...
fn directive_fragments_and_empty_bands_are_skipped() {
    let directive = Fragment::new(
        ...
        10.0,
        10.0,
        FragmentContent::Directive(turbo_html2pdf_core::TKind::Page),
    );
...
fn font_store_reports_emptiness() {
    use turbo_html2pdf_core::emit::FontStore;
