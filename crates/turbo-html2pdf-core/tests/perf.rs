...
//! feature; run with `cargo test -p turbo-html2pdf-core --features perf`. They assert
...
fn report_hot_path_breakdown() {
    ...
    use turbo_html2pdf_core::{
        build_cascade, compile, layout, style_tree, CompileOptions, Diagnostics,
    };
