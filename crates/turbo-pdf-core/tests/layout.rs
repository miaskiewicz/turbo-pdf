...
fn collect_box_ids(b: &turbo_pdf_core::layout::boxgen::LayoutBox, out: &mut HashSet<NodeId>) {
...
fn collect_inline_ids(it: &turbo_pdf_core::layout::boxgen::InlineItem, out: &mut HashSet<NodeId>) {
    use turbo_pdf_core::layout::boxgen::InlineItem;
    match it {
